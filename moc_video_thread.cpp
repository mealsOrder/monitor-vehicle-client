/****************************************************************************
** Meta object code from reading C++ file 'video_thread.h'
**
...
#error "The header file 'video_thread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 27, 5) // "frame"
    ...
    "VideoThread\0frameCaptured\0\0frame"
};
...
void VideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->frameCaptured((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
...
// SIGNAL 0
void VideoThread::frameCaptured(const QImage & _t1)
{
